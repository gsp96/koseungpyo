        ...
        <div class='row'>
            <div class='col-12 text-center'>
                <div class='btn-group btn-block'>
                    <button type="button" class="btn btn-secondary" onclick="location.href='../movie/01.html' ">장르</button>
                    <button type="button" class="btn btn-secondary" onclick="location.href='../movie/02.html' ">연도별</button>
                    <button type="button" class="btn btn-secondary active" onclick="location.href='../movie/03.html' ">관객수별</button>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4 mt-5" style="float: none; margin:0 auto;">
                <form method="post" th:object="${order}">
                    <div class="form-group">
                        <label for="Years">관객수별</label>
                    </div>
    
                    <button class="btn btn-primary" type="submit">오름차순 조회</button>
                    <button class="btn btn-primary" type="submit">오름차순 조회</button>
                </form>
            </div>
        </div>
