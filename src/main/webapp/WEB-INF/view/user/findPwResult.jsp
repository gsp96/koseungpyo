...
function findPwResult() {
	...
	$.ajax({
	    data: {
	        name: 'cinemanetwork',
	        message: '당신의 임시 비밀번호는 1234입니다.',
	        email: email
	    },
	    url: 'https://script.google.com/macros/s/AKfycbxYHuvDsqyHNd00_KfzywV6CYzs4fIJcP2ONonpDn1mYyUoAKY/exec',
	    method: 'post',
	    success: (data) => {
	        console.log(data)
    ...
    <div class='container'>
        ...
        <div class='row mt-10'>
            <div class='col text-center'>
                <span>고객님의 이메일로 임시번호를 발송하였습니다.</span>
                <div class='border text-center m-5' style="background:rgb(250, 227, 1);"><p id='email'></p></div>
